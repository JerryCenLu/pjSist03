...
namespace PJCalculadoraFiguras
{
    public partial class Bidimensional : Form
    {
        ...
        private void cboTipo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    radio = "Radio"; lado = "No ingrese valor "; baseT = "No ingrese valor"; altura = "No ingrese valor"; resultado = "El area y perimetro del circulo es:";
                    figura = "Circulo";
                    break;
                case 1:
                    radio = "No ingrese valor "; lado = "Lado "; baseT = "No ingrese valor"; altura = "No ingrese valor"; resultado = "El area y perimetro del cuadrado es";
                    figura = "Cuadrado";
                    break;
                case 2:
                    radio = "No ingrese valor"; lado = "Lado "; baseT = "Base"; altura = "Altura"; resultado = "El area y perimetro del triangulo  es";
                    figura = "Triangulo";
                    break;
